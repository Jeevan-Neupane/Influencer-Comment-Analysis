...
const Chat = ({isOpen, setIsOpen}: Props) => {
  ...
  return (
    <>
      {isOpen ? (
        <div className="fixed top-[20%] left-[50%] translate-x-[-50%] border rounded-md ">
          <div
            onClick={toggleChatbot}
            className="bg-white text-gray-800 text-xl font-bold py-5 px-3 border-b flex justify-between gap-2 cursor-pointer"
          >
            ...
            <div className="">{isOpen ? <ImCross size={20} /> : ""}</div>
          </div>

          <div className="w-[600px]">
            <div className="bg-white  text-gray-900 shadow-lg h-[600px] flex flex-col justify-between">
